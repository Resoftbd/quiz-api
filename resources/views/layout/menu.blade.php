...
{{--                    </ul>--}}
{{--                </li>--}}
                @php($categories = \App\Http\Helpers\ViewHelper::getCategories())
                @if(count($categories)>0)
                    @foreach($categories as $key => $category)
                        <li class="nav-item"><a class="nav-link d-flex align-items-center" href="#"><span data-i18n="Apps">{{$category->name}}</span></a>
                        </li>
                    @endforeach
                @endif
